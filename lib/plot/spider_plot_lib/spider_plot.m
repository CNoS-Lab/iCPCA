...
% Changed by Abhijit CNOS lab to add roseplot
% Check if direction is valid char entry 
if ~ismember(direction, {'counterclockwise', 'clockwise','roseplot'})
    error('Error: Invalid direction entry. Please enter in "counterclockwise" or "clockwise" or "roseplot" to set direction of rotation.');
end
% End of changes
...
switch direction
    % Changes made my Abhijit - CNOS lab
    case 'roseplot'
